...
import { IssueDiagnosticDetails } from "@/components/shared/IssueDiagnosticDetails";
        ...
        <div className="flex-1 overflow-y-auto px-lg py-md text-left">
          {isBooked ? (
            ...
            <>
              ...
              {step === "results" && !recommendation && fileError && (
                <div className="rounded-lg border border-error/30 bg-error-container/30 p-md text-left">
                  <p className="font-headline text-headline-sm text-on-error-container">
                    Analysis unavailable
                  </p>
                  <p className="mt-sm font-body text-body-sm leading-relaxed text-on-error-container">
                    {fileError}
                  </p>
                </div>
              )}
