...
export const PERMISSION_DEFINITIONS: {
  ...
  {
    key: "consultations:read",
    name: "View Consultations",
    description: "Read free consultation requests from the website",
  },
  {
    key: "joinlist:read",
    name: "View Joinlist",
    description: "Read app waitlist sign-ups from the website",
  },
  ...
  { key: "media:read", name: "View Media", description: "Browse gallery media library" },
  { key: "media:write", name: "Manage Media", description: "Upload and delete gallery media" },
